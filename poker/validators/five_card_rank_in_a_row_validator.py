class FiveCardRankInARowValidator():
    ...
    def _collections_of_five_straight_cards_in_a_row(self):
        ...
        collections_of_five_straight_card_in_a_row = []
        ...
        while index + 4 <= final_index:
            ...
            if self._every_element_increasing_by_one(next_five_rank_indices):
                collections_of_five_straight_card_in_a_row.append(next_five_cards)
            index += 1

        return collections_of_five_straight_card_in_a_row
