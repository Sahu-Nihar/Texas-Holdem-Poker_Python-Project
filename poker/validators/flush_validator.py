class FlushValidator():
    ...
    def is_valid(self):
        return len(self._suits_that_occur_5_or_more_time) == 1

    def valid_cards(self):
        cards = [card for card in self.cards if card.suit in self._suits_that_occur_5_or_more_time.keys()]
        return cards[-5:]

    @property
    def _suits_that_occur_5_or_more_time(self):
        return {
            suit: suit_count
