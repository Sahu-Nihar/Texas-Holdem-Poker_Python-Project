...
class PlayerTest(unittest.TestCase):
    def test_stores_name_and_hand(self):
        hand = Hand()
        player = Player(name = "Nihar", hand = hand)
        self.assertEqual(player.name, "Nihar")
    ...
    def test_figures_out_own_best_hand(self):
        ...
        player = Player(name = "Nihar", hand = mock_hand)
    ...
    def test_passes_new_card_to_hand(self):
        mock_hand = MagicMock()
        player = Player(name = "Hiyori", hand = mock_hand)
    ...
    def test_decides_to_continue_or_drop_out_of_game(self):
        player = Player(name = "Ryuma", hand = Hand())
        self.assertEqual(
    ...
    def test_is_sorted_by_best_hand(self):
        ...
        player1 = Player(name = "Zoro", hand = mock_hand1)
        player2 = Player(name = "King The Calamity", hand = mock_hand2)
